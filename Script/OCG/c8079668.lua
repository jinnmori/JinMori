...
function s.initial_effect(c)
	...
	c:RegisterEffect(e2)
	-- Special Summon 1 "cyber dragon" monster from your GY
...
function s.spcostfilter(c,tp)
	return c:IsRace(RACE_MACHINE) and c:IsAbleToGraveAsCost() and (c:IsFaceup() or not c:IsOnField())
